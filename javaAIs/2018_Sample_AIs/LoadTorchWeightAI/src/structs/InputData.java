...
public class InputData {
	...
	public InputData(GameData gameData, boolean player, ArrayList<CharacterData> my, ArrayList<CharacterData> opp,
			ArrayList<FrameData> frame, ArrayList<Action> delay_actions) {
		Input = convert(gameData, player, my, opp, frame, delay_actions);
	}
	...
	double[] convert(GameData gameData, boolean player, ArrayList<CharacterData> my_list,
